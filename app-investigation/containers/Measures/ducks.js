...
export const ADD_MEASURE = ducks.defineType('ADD_MEASURE');
...
export const addMeasure = ducks.createAction(ADD_MEASURE);
export const changeEditableRecord = ducks.createAction(
  CHANGE_EDITABLE_RECORD,
);

const emptyMeasureRecord = {
  id: 0,
  measure: '',
};
...
export default ducks.createReducer(
  {
    ...
    [ADD_MEASURE]: state =>
      state
        .set('editableRecord', emptyMeasureRecord)
        .updateIn(['data'], reasons => reasons.unshift(fromJS(emptyMeasureRecord))),
